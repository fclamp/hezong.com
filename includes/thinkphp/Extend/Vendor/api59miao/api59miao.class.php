...
class Api59miao
{
	...
	public function ListItemsSearch($fields=null,$keyword, $cid = null, $sid = null, $page_no = 1, $page_size = 40,$star_price=null,$end_price=null,$sort=null)
	{
		...
		if(!$fields){
			$fields = 'iid,click_url,seller_url,title,sid,seller_name,has_taobao,popular,cid,desc,pic_url,price,cash_ondelivery,freeshipment,installment,has_invoice,modified,price_reduction,price_decreases,original_price';
		}
		if($keyword)
		{
