...
</script><div style="padding:10px; overflow:hidden;"><div style="width:49%;" ><div class="main_con fl"><h6>我的个人信息</h6><div class="content"><p>您好，<b style="color:#06C"><?php echo ($my_info["user_name"]); ?></b> &nbsp;[<?php echo ($admin_level["name"]); ?>] <br></p><div class="hr"></div></div></div></div></div></body></html>