...
<div style="padding: 10px;">
     ...
     <div class="table-list">
	    <table width="100%" cellspacing="0">
	        <thead>
				<tr>                
	                <th>编辑 角色【<?php echo ($role_info['name']); ?>】权限</th>
	            </tr>
	        </thead>
	    	<tbody>
	    	</tbody>
    ...
    <form action="<?php echo u('role/auth_submit');?>" method="post" name="myform" id="myform">
    ...
    <div>
     ...
     <div class="table-list">
	    <table width="100%" cellspacing="0">
	    	...
	    	<tbody>
	        <?php if(is_array($depart_access_list)): $k = 0; $__LIST__ = $depart_access_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($k % 2 );++$k;?><tr>
	        	<td align="center"><?php echo ($val["id"]); ?></td>
	            <td align="center"><input type="checkbox" depart="pid_<?php echo ($val["pid"]); ?>" value="<?php echo ($val["id"]); ?>" name="departids[]" <?php if($val['checked']): ?>checked="checked"<?php endif; ?>></td>                       
