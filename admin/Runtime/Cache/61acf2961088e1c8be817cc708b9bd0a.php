...
<html xmlns="http://www.w3.org/1999/xhtml" class="off on">
<head>
...
<div id="content">
    <div class="left_menu fl left_menu_on">
        <div id="leftMain"></div>
        <a href="javascript:;" id="openClose" style="outline-style: none; outline-color: invert; outline-width: medium;" hideFocus="hidefocus" class="open close" title="<?php echo ($lang["expand_or_contract"]); ?>"></a>
	 </div>
    <div class="right_main">
        <div class="crumbs">
            <div class="shortcut cu-span">
            	<?php if(is_access('cache','index') == '1'): ?><a href="<?php echo u('cache/index');?>" target="right">
